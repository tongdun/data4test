...
--
-- Host: 127.0.0.1    Database: data4test_1
-- ------------------------------------------------------
...
CREATE TABLE `ai_case` (
  ...
  `case_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用例编号',
  `case_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用例名称',
  `case_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '用例类型',
  `priority` varchar(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '优先级',
  `pre_condition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '前置条件',
  `test_range` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '测试范围',
  `test_steps` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '测试步骤',
  `expect_result` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '预期结果',
  `auto` enum('0','1','2') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '1' COMMENT '是否自动化，0:否, 1:是, 2:部分是',
  `module` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '所属模块',
  `intro_version` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '引入版本',
  `case_version` int DEFAULT '1' COMMENT '用例版本',
  `product` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关联产品',
...
CREATE TABLE `ai_data` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '数据描述',
  ...
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '文件内容',
  `source` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '生成来源: DeepSeek/OpenAi/Kimi等',
  `file_name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '文件名称',
...
CREATE TABLE `ai_issue` (
  ...
  `source` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '生成来源',
  `request_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '请求数据: url, header, request等',
  `response_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '返回数据: response',
  ...
  `resolution_status` enum('1','2','3','4','5') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '1' COMMENT '解决状态, 1:创建, 2:解决中, 3:修复完成, 4:验证完成, 5:不处理',
...
--
-- Table structure for table `ai_playbook`
--
...
CREATE TABLE `ai_playbook` (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '场景描述',
  `data_file_list` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '数据文件列表',
  `last_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '最近数据文件',
  `scene_type` enum('1','2','3','4','5') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '1' COMMENT '场景类型，1:串行中断，2:串行比较，3:串行继续，4:普通并发, 5:并发比较',
...
CREATE TABLE `ai_template` (
  ...
  `template_type` enum('1','2','3','4','5','6','7') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '1' COMMENT '模板类型，1:用例，2:数据，3:场景，4:任务, 5:Issue, 6: 报告， 7: 分析',
  `template_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '模板内容',
  `append_conversion` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '追加对话',
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='断言值多语言模板';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `case_statistics` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '统计定义名称',
  `definition` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'YAML定义(ext_info + tree)',
  `intro_versions` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '引入版多选(逗号分隔)',
  `product` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '关联产品线(逗号分隔)',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'none' COMMENT '状态: none/generating/finished/failed',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用例统计定义表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `case_statistics_report`
--

DROP TABLE IF EXISTS `case_statistics_report`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `case_statistics_report` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  ...
  `intro_versions` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关联产品线',
  `product` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '关联产品线(逗号分隔)',
  `stat_start_time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '统计开始时间(最早测试时间)',
  `stat_end_time` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '统计结束时间(最晚测试时间)',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'finished' COMMENT '状态: generating/finished/failed',
  `creator` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '创建人',
  `report_data` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '统计数据JSON',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '备注',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `deleted_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_related_stat_id` (`related_stat_id`),
  KEY `idx_created_at` (`created_at`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用例报告列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dashboard` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `report_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '报告名称',
  `report_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '报告类型: global/product/app/task',
  `related_task_ids` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '关联任务ID列表(逗号分隔)',
  `related_products` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '关联产品名称列表(逗号分隔)',
  `related_apps` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '关联应用名称列表(逗号分隔)',
  `time_range_start` datetime DEFAULT NULL COMMENT '统计时间范围开始',
  `time_range_end` datetime DEFAULT NULL COMMENT '统计时间范围结束',
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'generating' COMMENT '生成状态: generating/finished/failed',
  `creator` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '创建人',
  ...
  KEY `idx_created_at` (`created_at`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='执行报告汇总表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='环境配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `goadmin_menu` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2765 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `playbook` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '场景描述',
  `data_number` text CHARACTER SET utf8 COLLATE utf8_unicode_ci COMMENT '数据序号/标签',
  `data_file_list` text CHARACTER SET utf8 COLLATE utf8_unicode_ci COMMENT '数据文件列表',
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='场景列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product` (
  ...
  `private_app_prefix` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT '专用应用前缀',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='产品配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `scene_data` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '数据描述',
  `api_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '接口ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=90 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='场景数据';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `scene_data_test_history` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `task_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '任务执行ID: scheduleId_执行时间',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '数据描述',
  `api_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '接口ID',
  `app` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '所属应用',
  ...
  `env_type` int DEFAULT NULL COMMENT '环境类型，e.g.: 1: 开发，2: 测试，3: 预发，4: 演示，5：生产',
  `file_type` enum('1','2','3','4','5','99') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '所属产品',
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='场景数据测试记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `scene_test_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_task_id` (`task_id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='场景测试记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='定时任务';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_parameter` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统参数';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `test_case` (
  ...
  `fun_developer` varchar(64) DEFAULT NULL COMMENT '功能开发者',
  `case_designer` varchar(64) DEFAULT NULL COMMENT '用例设计者',
  `case_executor` varchar(64) DEFAULT NULL COMMENT '用例执行者',
  `test_time` varchar(20) DEFAULT NULL COMMENT '测试时间',
  `result_history` longtext COMMENT '测试结果历史: 每行 序号|结果|执行人|时间',
  ...
  `test_process` longtext COMMENT '测试过程截图',
  `ext_info` longtext COMMENT '扩展信息(YAML)',
...
-- Dump completed on 2026-09-16 13:54:56
-- ===== 框架数据（整表）=====
-- MySQL dump 10.13  Distrib 5.7.24, for osx10.9 (x86_64)
--
-- Host: 127.0.0.1    Database: data4test_1
...
INSERT INTO `filemanager_setting` VALUES (1,'roots','{\"ai_data\":{\"Path\":\"mgmt/ai_data\",\"Title\":\"智能数据\"},\"api\":{\"Path\":\"mgmt/api\",\"Title\":\"接口文件\"},\"case\":{\"Path\":\"mgmt/case\",\"Title\":\"用例文件\"},\"common\":{\"Path\":\"mgmt/common\",\"Title\":\"公用文件(勿删)\"},\"data\":{\"Path\":\"mgmt/data\",\"Title\":\"数据文件\"},\"download\":{\"Path\":\"mgmt/download\",\"Title\":\"下载文件\"},\"history\":{\"Path\":\"mgmt/history\",\"Title\":\"历史记录\"},\"i18n\":{\"Path\":\"mgmt/i18n\",\"Title\":\"i18n文件\"},\"log\":{\"Path\":\"mgmt/log\",\"Title\":\"日志管理\"},\"old\":{\"Path\":\"mgmt/old\",\"Title\":\"历史版本\"},\"upload\":{\"Path\":\"mgmt/upload\",\"Title\":\"上传文件\"}}','2020-12-07 02:35:59','2020-12-07 02:35:59'),(2,'allowMove','1','2020-12-07 02:36:00','2020-12-07 02:36:00'),(3,'conn','default','2020-12-07 02:36:00','2020-12-07 02:36:00'),(4,'allowUpload','1','2020-12-07 02:36:00','2020-12-07 02:36:00'),(5,'allowDelete','1','2020-12-07 02:36:00','2020-12-07 02:36:00'),(6,'allowRename','1','2020-12-07 02:36:00','2020-12-07 02:36:00'),(7,'allowDownload','1','2020-12-07 02:36:00','2020-12-07 02:36:00'),(8,'allowCreateDir','1','2020-12-07 02:36:00','2020-12-07 02:36:00');
...
INSERT INTO `goadmin_menu` VALUES (1,0,1,65,'Admin','fa-tasks','',NULL,'',NULL,'2019-09-09 16:00:00','2019-09-09 16:00:00'),(2,1,1,65,'用户','fa-users','/info/manager','','',NULL,'2019-09-09 16:00:00','2026-09-15 07:32:11'),(3,1,1,66,'角色','fa-user','/info/roles','','',NULL,'2019-09-09 16:00:00','2026-09-15 07:32:19'),(4,1,1,67,'权限','fa-ban','/info/permission','','',NULL,'2019-09-09 16:00:00','2026-09-15 07:32:25'),(5,1,1,68,'菜单','fa-bars','/menu','','',NULL,'2019-09-09 16:00:00','2026-09-15 07:32:33'),(6,50,1,64,'操作日志','fa-history','/info/op','','',NULL,'2019-09-09 16:00:00','2026-09-15 07:32:00'),(7,0,1,1,'大盘','fa-bar-chart','/dashboard','','',NULL,'2019-09-09 16:00:00','2026-09-15 07:31:48'),(8,0,1,19,'环境','fa-cog','','','',NULL,'2020-11-23 02:47:56','2020-11-23 02:57:07'),(9,8,1,20,'应用配置','fa-bars','/info/env_config','','',NULL,'2020-11-23 02:57:40','2021-07-29 06:04:57'),(12,0,1,8,'接口','fa-bank','','','',NULL,'2020-11-23 02:59:22','2021-03-21 07:08:41'),(14,0,1,15,'结果','fa-cubes','','','',NULL,'2020-11-23 02:59:57','2020-11-23 02:59:57'),(25,12,1,8,'接口定义','fa-bars','/info/api_definition','','',NULL,'2020-11-24 09:22:39','2021-03-22 09:48:08'),(34,28,1,22,'Swagger文件','fa-bars','/fm/api/list','','',NULL,'2020-12-07 03:06:28','2020-12-07 03:06:28'),(37,28,1,21,'用例文件','fa-bars','/fm/test/list','','',NULL,'2020-12-07 03:08:41','2020-12-07 03:08:41'),(38,28,1,20,'公共文件','fa-bars','/fm/file/list','','',NULL,'2020-12-07 03:09:05','2020-12-07 03:09:05'),(39,0,1,23,'文件','fa-files-o','','','',NULL,'2020-12-07 03:20:35','2020-12-10 03:17:02'),(40,39,1,32,'公用文件','fa-bars','/fm/common/list','','',NULL,'2020-12-07 03:23:33','2026-09-16 05:46:04'),(41,39,1,30,'用例文件','fa-bars','/fm/case/list','','',NULL,'2020-12-07 03:23:49','2023-08-11 10:05:06'),(42,39,1,29,'API文件','fa-bars','/fm/api/list','','',NULL,'2020-12-07 03:24:04','2020-12-07 03:24:04'),(44,39,1,33,'日志文件','fa-bars','/fm/log/list','','',NULL,'2020-12-10 03:08:30','2020-12-10 03:17:15'),(45,0,1,11,'日志文件','fa-bars','/fm/log/list','','filemanager',NULL,'2020-12-10 03:09:23','2020-12-10 03:16:07'),(46,0,1,8,'用例文件','fa-bars','/fm/case/list','','filemanager',NULL,'2020-12-10 03:10:06','2023-08-11 10:00:56'),(47,0,1,7,'API文件','fa-bars','/fm/api/list','','filemanager',NULL,'2020-12-10 03:10:35','2020-12-10 03:10:35'),(48,0,1,10,'公用文件','fa-bars','/fm/common/list','','filemanager',NULL,'2020-12-10 03:10:56','2023-08-11 10:01:05'),(50,0,1,64,'日志','fa-500px','','','',NULL,'2021-03-18 14:52:09','2021-03-18 14:53:17'),(101,0,1,34,'说明','fa-bars','','','',NULL,'2021-03-23 06:14:06','2021-03-23 06:16:25'),(126,101,1,34,'概览','fa-bars','/librarian/README','','',NULL,'2021-03-24 03:27:58','2021-03-24 03:27:58'),(127,101,1,1,'概览','fa-bars','/librarian/README','','librarian',NULL,'2021-03-24 03:30:28','2021-03-24 03:31:42'),(137,0,1,13,'场景','fa-bars','','','',NULL,'2021-06-03 03:42:23','2021-06-03 03:42:23'),(138,137,1,13,'场景列表','fa-bars','/info/playbook','','',NULL,'2021-06-03 03:43:06','2021-06-03 03:43:57'),(139,137,1,14,'数据列表','fa-bars','/info/scene_data','','',NULL,'2021-06-03 03:43:19','2021-07-29 06:20:10'),(140,0,1,1,'数据文件','fa-bars','/fm/data/list','','filemanager',NULL,'2021-06-03 06:02:31','2023-08-11 10:00:46'),(141,39,1,23,'数据文件','fa-bars','/fm/data/list','','',NULL,'2021-06-04 02:08:36','2023-08-11 10:04:51'),(202,8,1,19,'产品配置','fa-bars','/info/product','','',NULL,'2021-07-19 07:44:29','2021-07-19 07:44:29'),(203,0,1,18,'任务','fa-arrows-alt','','','',NULL,'2021-07-23 09:09:57','2021-07-29 05:55:14'),(204,203,1,18,'定时任务','fa-bars','/info/schedule','','',NULL,'2021-07-23 09:10:20','2021-07-23 09:10:20'),(205,0,1,3,'上传文件','fa-bars','/fm/upload/list','','filemanager',NULL,'2021-08-04 02:47:48','2021-08-04 02:47:48'),(206,0,1,4,'下载文件','fa-bars','/fm/download/list','','filemanager',NULL,'2021-08-04 02:48:01','2021-08-04 02:48:01'),(207,0,1,5,'历史记录','fa-bars','/fm/history/list','','filemanager',NULL,'2021-08-04 02:48:10','2021-08-04 02:58:05'),(208,39,1,25,'上传文件','fa-bars','/fm/upload/list','','',NULL,'2021-08-04 02:50:17','2021-08-04 02:50:17'),(209,39,1,26,'历史记录','fa-bars','/fm/history/list','','',NULL,'2021-08-04 02:50:27','2021-08-04 02:50:27'),(210,39,1,28,'下载文件','fa-bars','/fm/download/list','','',NULL,'2021-08-04 02:50:35','2021-08-04 02:50:35'),(211,8,1,21,'系统参数','fa-bars','/info/sys_parameter','','',NULL,'2021-08-06 03:55:26','2021-08-06 03:55:26'),(212,14,1,15,'数据测试历史','fa-bars','/info/scene_data_test_history','','',NULL,'2021-08-10 07:03:22','2023-04-27 09:13:17'),(213,14,1,16,'场景测试历史','fa-bars','/info/scene_test_history','','',NULL,'2021-08-10 07:04:29','2022-03-09 05:59:35'),(214,39,1,27,'历史版本','fa-bars','/fm/old/list','','',NULL,'2021-08-30 06:46:40','2021-08-30 06:46:40'),(215,0,1,6,'历史版本','fa-bars','/fm/old/list','','filemanager',NULL,'2021-08-30 06:47:36','2021-08-30 06:47:36'),(216,0,1,10,'用例','fa-bars','','','',NULL,'2021-09-05 02:48:39','2021-09-05 02:48:39'),(217,216,1,10,'测试用例列表','fa-bars','/info/test_case','','',NULL,'2021-09-05 02:49:29','2026-09-15 07:41:54'),(236,0,1,2,'控制台','fa-bars','/likePostman','','',NULL,'2021-12-03 06:32:52','2022-03-07 02:24:16'),(237,12,1,9,'接口记录表','fa-bars','/info/app_api_changelog','','',NULL,'2022-03-08 02:25:03','2022-03-08 02:25:03'),(2224,8,1,22,'断言值模板','fa-bars','/info/assert_template','','',NULL,'2023-12-11 07:31:19','2023-12-11 08:09:41'),(2607,0,1,3,'助手','fa-bars','','','',NULL,'2025-04-02 09:25:24','2025-04-02 18:41:49'),(2608,2607,1,6,'智能用例','fa-bars','/info/ai_case','','',NULL,'2025-04-02 09:28:07','2025-04-02 17:45:26'),(2611,2607,1,7,'智能模板','fa-bars','/info/ai_template','','',NULL,'2025-04-10 08:41:31','2025-04-10 08:41:31'),(2612,2607,1,5,'智能数据','fa-bars','/info/ai_data','','',NULL,'2025-04-24 01:50:26','2025-04-24 01:50:57'),(2613,0,1,2,'智能数据','fa-bars','/fm/ai_data/list','','filemanager',NULL,'2025-04-24 08:43:17','2025-04-25 01:34:58'),(2614,39,1,24,'智能数据','fa-bars','/fm/ai_data/list','','',NULL,'2025-04-24 08:44:53','2025-04-24 08:44:53'),(2615,2607,1,4,'智能场景','fa-bars','/info/ai_playbook','','',NULL,'2025-04-27 03:13:50','2025-04-27 03:13:50'),(2616,2607,1,3,'智能分析','fa-bars','/info/ai_issue','','',NULL,'2025-06-10 06:13:55','2025-06-11 08:53:28'),(2687,101,1,35,'系统使用','fa-bars','','','',NULL,'2025-07-01 07:18:33','2025-07-01 07:18:33'),(2688,2687,1,35,'控制台使用','fa-bars','/librarian/design/console_design','','',NULL,'2025-07-01 07:19:28','2025-07-01 07:20:02'),(2689,2687,1,36,'接口管理','fa-bars','/librarian/design/api_mgmt_design','','',NULL,'2025-07-01 07:21:21','2025-07-01 07:21:21'),(2690,2687,1,38,'用例管理','fa-bars','/librarian/design/testcase_design','','',NULL,'2025-07-01 07:21:40','2025-07-01 07:21:40'),(2691,2687,1,37,'数据管理','fa-bars','/librarian/design/data_file_design','','',NULL,'2025-07-01 07:21:58','2025-07-01 07:21:58'),(2692,2687,1,39,'场景管理','fa-bars','/librarian/design/playbook_design','','',NULL,'2025-07-01 07:22:17','2025-07-01 07:22:17'),(2693,2687,1,40,'任务管理','fa-bars','/librarian/design/task_design','','',NULL,'2025-07-01 07:22:35','2025-07-01 07:22:35'),(2694,2687,1,41,'Mock使用','fa-bars','/librarian/design/mock_design','','',NULL,'2025-07-01 07:22:54','2025-07-01 07:22:54'),(2695,2687,1,43,'常见问题','fa-bars','/librarian/question/FAQ','','',NULL,'2025-07-01 07:23:19','2025-07-01 07:23:19'),(2696,101,1,44,'智能助手','fa-bars','','','',NULL,'2025-07-01 07:23:49','2025-07-01 07:23:49'),(2698,101,1,53,'系统设计','fa-bars','','','',NULL,'2025-07-01 07:24:14','2025-07-01 07:24:14'),(2699,101,1,59,'研发事项','fa-bars','','','',NULL,'2025-07-01 07:24:23','2025-07-01 07:24:23'),(2700,101,1,62,'系统变更','fa-bars','','','',NULL,'2025-07-01 07:24:33','2025-07-01 07:24:33'),(2701,2696,1,44,'智能用例','fa-bars','/librarian/ai/ai_testcase_design','','',NULL,'2025-07-01 07:25:46','2025-07-01 07:25:46'),(2702,2696,1,45,'智能数据','fa-bars','/librarian/ai/ai_data_design','','',NULL,'2025-07-01 07:26:10','2025-07-01 07:26:10'),(2703,2696,1,46,'智能场景','fa-bars','/librarian/ai/ai_playbook_design','','',NULL,'2025-07-01 07:26:30','2025-07-01 07:26:30'),(2704,2696,1,47,'智能分析','fa-bars','/librarian/ai/ai_analysis_design','','',NULL,'2025-07-01 07:26:54','2025-07-01 07:26:54'),(2705,2696,1,48,'智能模板','fa-bars','/librarian/ai/ai_template_design','','',NULL,'2025-07-01 07:27:50','2025-07-01 07:27:50'),(2706,2721,1,49,'参数说明','fa-bars','/librarian/design/parameter_design','','',NULL,'2025-07-01 07:28:32','2025-07-01 07:28:32'),(2707,2721,1,50,'动作说明','fa-bars','/librarian/design/action_design','','',NULL,'2025-07-01 07:28:49','2025-07-01 07:28:49'),(2708,2721,1,51,'断言说明','fa-bars','/librarian/design/assert_design','','',NULL,'2025-07-01 07:29:10','2025-07-01 07:29:10'),(2709,2721,1,52,'脚本说明','fa-bars','/librarian/design/script_design','','',NULL,'2025-07-01 07:29:29','2025-07-01 07:29:29'),(2710,2698,1,53,'架构图','fa-bars','/librarian/arch/arch','','',NULL,'2025-07-01 07:29:49','2025-07-01 07:29:49'),(2711,2698,1,54,'发展规划','fa-bars','/librarian/plan/blue_print','','',NULL,'2025-07-01 07:30:11','2025-07-01 07:30:11'),(2712,2698,1,55,'功能特性','fa-bars','/librarian/function/feature_introduction','','',NULL,'2025-07-01 07:30:28','2025-07-01 07:30:28'),(2713,2698,1,56,'模块特性','fa-bars','/librarian/function/module_function','','',NULL,'2025-07-01 07:30:46','2025-07-01 07:30:46'),(2714,2698,1,57,'性能测试设计','fa-bars','/librarian/design/perf_design','','',NULL,'2025-07-01 07:31:07','2025-07-01 07:31:07'),(2715,2698,1,58,'模糊测试设计','fa-bars','/librarian/design/fuzzing_design','','',NULL,'2025-07-01 07:31:31','2025-07-01 07:31:31'),(2716,2699,1,59,'数据库设计','fa-bars','/librarian/design/db_design','','',NULL,'2025-07-01 07:32:21','2025-07-01 07:32:21'),(2717,2699,1,60,'开发待办','fa-bars','/librarian/plan/todo','','',NULL,'2025-07-01 07:32:40','2025-07-01 07:32:40'),(2718,2699,1,61,'开发须知','fa-bars','/librarian/development/must_know','','',NULL,'2025-07-01 07:33:03','2025-07-01 07:33:03'),(2719,2700,1,62,'最新发布','fa-bars','/librarian/update/release','','',NULL,'2025-07-01 07:33:26','2025-07-01 07:33:26'),(2720,2700,1,63,'变更日志','fa-bars','/librarian/update/change_log','','',NULL,'2025-07-01 07:33:45','2025-07-01 07:33:45'),(2721,101,1,49,'数据文件','fa-bars','','','',NULL,'2025-07-01 07:37:46','2025-07-01 07:37:46'),(2722,216,1,11,'用例统计定义','fa-bars','/info/case_statistics','','',NULL,'2026-09-15 07:42:23','2026-09-15 07:42:23'),(2723,216,1,12,'用例报告列表','fa-bars','/info/case_statistics_report','','',NULL,'2026-09-15 07:42:44','2026-09-15 07:42:44'),(2724,0,1,9,'i18n文件','fa-bars','/fm/i18n/list','','filemanager',NULL,'2026-09-15 07:46:31','2026-09-15 07:46:31'),(2725,39,1,31,'i18n文件','fa-bars','/fm/i18n/list','','',NULL,'2026-09-15 07:50:29','2026-09-15 07:50:29'),(2726,0,1,1,'概览','fa-file-o','/librarian/README','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2727,0,1,1,'系统使用','fa-file-o','','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2728,2727,1,1,'控制台使用','fa-file-o','/librarian/design/console_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2729,2727,1,1,'接口管理','fa-file-o','/librarian/design/api_mgmt_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2730,2727,1,1,'用例管理','fa-file-o','/librarian/design/testcase_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2731,2727,1,1,'数据管理','fa-file-o','/librarian/design/data_file_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2732,2727,1,1,'场景管理','fa-file-o','/librarian/design/playbook_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2733,2727,1,1,'任务管理','fa-file-o','/librarian/design/task_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2734,2727,1,1,'Mock使用','fa-file-o','/librarian/design/mock_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2735,2727,1,1,'公共管理','fa-file-o','/librarian/design/common_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2736,2727,1,1,'常见问题','fa-file-o','/librarian/question/FAQ','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2737,0,1,1,'智能助手','fa-file-o','','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2738,2737,1,1,'智能用例','fa-file-o','/librarian/ai/ai_testcase_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2739,2737,1,1,'智能数据','fa-file-o','/librarian/ai/ai_data_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2740,2737,1,1,'智能场景','fa-file-o','/librarian/ai/ai_playbook_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2741,2737,1,1,'智能分析','fa-file-o','/librarian/ai/ai_analysis_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2742,2737,1,1,'智能模板','fa-file-o','/librarian/ai/ai_template_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2743,0,1,1,'数据文件','fa-file-o','','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2744,2743,1,1,'参数说明','fa-file-o','/librarian/design/parameter_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2745,2743,1,1,'动作说明','fa-file-o','/librarian/design/action_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2746,2743,1,1,'断言说明','fa-file-o','/librarian/design/assert_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2747,2743,1,1,'脚本说明','fa-file-o','/librarian/design/script_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2748,0,1,1,'系统设计','fa-file-o','','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2749,2748,1,1,'架构图','fa-file-o','/librarian/arch/arch','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2750,2748,1,1,'发展规划','fa-file-o','/librarian/plan/blue_print','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2751,2748,1,1,'功能特性','fa-file-o','/librarian/function/feature_introduction','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2752,2748,1,1,'模块特性','fa-file-o','/librarian/function/module_function','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2753,2748,1,1,'性能测试设计','fa-file-o','/librarian/design/perf_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2754,2748,1,1,'模糊测试设计','fa-file-o','/librarian/design/fuzzing_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2755,0,1,1,'研发事项','fa-file-o','','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2756,2755,1,1,'数据库设计','fa-file-o','/librarian/design/db_design','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2757,2755,1,1,'开发待办','fa-file-o','/librarian/plan/todo','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2758,2755,1,1,'开发须知','fa-file-o','/librarian/development/must_know','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2759,2755,1,1,'开发环境','fa-file-o','/librarian/development/dev_env','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2760,0,1,1,'系统变更','fa-file-o','','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2761,2760,1,1,'最新发布','fa-file-o','/librarian/update/release','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2762,2760,1,1,'变更日志','fa-file-o','/librarian/update/change_log','','librarian','','2026-09-15 08:07:54','2026-09-15 08:07:54'),(2763,14,1,17,'结果报告列表','fa-bars','/info/dashboard','','',NULL,'2026-09-15 08:09:49','2026-09-15 08:09:49'),(2764,2687,0,42,'公共管理','fa-bars','/librarian/design/common_design','','',NULL,'2026-09-16 05:48:28','2026-09-16 05:48:28');
...
INSERT INTO `goadmin_role_menu` VALUES (1,1,'2019-09-09 16:00:00','2019-09-09 16:00:00'),(1,8,'2020-11-23 02:57:07','2020-11-23 02:57:07'),(2,8,'2020-11-23 02:57:07','2020-11-23 02:57:07'),(1,34,'2020-12-07 03:06:28','2020-12-07 03:06:28'),(2,34,'2020-12-07 03:06:28','2020-12-07 03:06:28'),(1,37,'2020-12-07 03:08:41','2020-12-07 03:08:41'),(2,37,'2020-12-07 03:08:41','2020-12-07 03:08:41'),(1,38,'2020-12-07 03:09:05','2020-12-07 03:09:05'),(2,38,'2020-12-07 03:09:05','2020-12-07 03:09:05'),(1,42,'2020-12-07 03:24:04','2020-12-07 03:24:04'),(2,42,'2020-12-07 03:24:04','2020-12-07 03:24:04'),(1,47,'2020-12-10 03:10:35','2020-12-10 03:10:35'),(2,47,'2020-12-10 03:10:35','2020-12-10 03:10:35'),(1,45,'2020-12-10 03:16:07','2020-12-10 03:16:07'),(2,45,'2020-12-10 03:16:07','2020-12-10 03:16:07'),(1,39,'2020-12-10 03:17:02','2020-12-10 03:17:02'),(2,39,'2020-12-10 03:17:02','2020-12-10 03:17:02'),(1,44,'2020-12-10 03:17:15','2020-12-10 03:17:15'),(2,44,'2020-12-10 03:17:15','2020-12-10 03:17:15'),(1,50,'2021-03-18 14:53:17','2021-03-18 14:53:17'),(1,25,'2021-03-22 09:48:08','2021-03-22 09:48:08'),(2,25,'2021-03-22 09:48:08','2021-03-22 09:48:08'),(1,9,'2021-07-29 06:04:57','2021-07-29 06:04:57'),(2,9,'2021-07-29 06:04:57','2021-07-29 06:04:57'),(3,9,'2022-03-09 07:19:56','2022-03-09 07:19:56'),(3,8,'2022-03-09 07:20:47','2022-03-09 07:20:47'),(5,236,'2022-03-09 07:30:24','2022-03-09 07:30:24'),(1,46,'2023-08-11 10:00:56','2023-08-11 10:00:56'),(2,46,'2023-08-11 10:00:56','2023-08-11 10:00:56'),(1,48,'2023-08-11 10:01:05','2023-08-11 10:01:05'),(2,48,'2023-08-11 10:01:05','2023-08-11 10:01:05'),(1,41,'2023-08-11 10:05:06','2023-08-11 10:05:06'),(2,41,'2023-08-11 10:05:06','2023-08-11 10:05:06'),(1,7,'2026-09-15 07:31:48','2026-09-15 07:31:48'),(2,7,'2026-09-15 07:31:48','2026-09-15 07:31:48'),(3,2726,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2727,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2728,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2729,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2730,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2731,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2732,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2733,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2734,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2735,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2736,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2737,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2738,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2739,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2740,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2741,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2742,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2743,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2744,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2745,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2746,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2747,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2748,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2749,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2750,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2751,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2752,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2753,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2754,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2755,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2756,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2757,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2758,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2759,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2760,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2761,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(3,2762,'2026-09-15 08:07:54','2026-09-15 08:07:54'),(1,40,'2026-09-16 05:46:04','2026-09-16 05:46:04'),(2,40,'2026-09-16 05:46:04','2026-09-16 05:46:04');
...
-- Dump completed on 2026-09-16 13:54:57
-- ===== 内置数据：assert_template WHERE name IN ('successTemplate') =====
-- MySQL dump 10.13  Distrib 5.7.24, for osx10.9 (x86_64)
--
-- Host: 127.0.0.1    Database: data4test_1
-- ------------------------------------------------------
...
-- Dump completed on 2026-09-16 13:54:57
-- ===== 内置数据：env_config WHERE app IN ('exampleApp') =====
-- MySQL dump 10.13  Distrib 5.7.24, for osx10.9 (x86_64)
--
-- Host: 127.0.0.1    Database: data4test_1
-- ------------------------------------------------------
...
-- Dump completed on 2026-09-16 13:54:58
-- ===== 内置数据：sys_parameter WHERE name IN ('fileName','scriptRunEngine','aiRunEngine','aiPlatform','Router4Add','TestCaseType','RUID','testCaseExportTemplates','caseProduct','supportLanguages') =====
-- MySQL dump 10.13  Distrib 5.7.24, for osx10.9 (x86_64)
--
-- Host: 127.0.0.1    Database: data4test_1
-- ------------------------------------------------------
...
-- Dump completed on 2026-09-16 13:54:59
-- ===== 内置数据：scene_data WHERE name IN ('示例-用户管理-新建用户') =====
-- MySQL dump 10.13  Distrib 5.7.24, for osx10.9 (x86_64)
--
-- Host: 127.0.0.1    Database: data4test_1
-- ------------------------------------------------------
...
-- Dump completed on 2026-09-16 13:55:00
-- ===== 内置数据：product WHERE product IN ('示例产品') =====
-- MySQL dump 10.13  Distrib 5.7.24, for osx10.9 (x86_64)
--
-- Host: 127.0.0.1    Database: data4test_1
-- ------------------------------------------------------
...
-- Dump completed on 2026-09-16 13:55:00
-- ===== 内置数据：playbook WHERE name IN ('示例场景') =====
-- MySQL dump 10.13  Distrib 5.7.24, for osx10.9 (x86_64)
--
-- Host: 127.0.0.1    Database: data4test_1
-- ------------------------------------------------------
...
-- Dump completed on 2026-09-16 13:55:01
-- ===== 内置数据：schedule WHERE task_name IN ('示例任务-关联场景-一次性','示例任务-关联数据-自定义执行','示例任务-关联场景-每天0点和12点执行','示例任务-关联场景-每周六和每周日0点和20点执行') =====
-- MySQL dump 10.13  Distrib 5.7.24, for osx10.9 (x86_64)
--
-- Host: 127.0.0.1    Database: data4test_1
-- ------------------------------------------------------
...
--
-- WHERE:  task_name IN ('示例任务-关联场景-一次性','示例任务-关联数据-自定义执行','示例任务-关联场景-每天0点和12点执行','示例任务-关联场景-每周六和每周日0点和20点执行')

LOCK TABLES `schedule` WRITE;
/*!40000 ALTER TABLE `schedule` DISABLE KEYS */;
INSERT INTO `schedule` VALUES (1,'示例任务-关联场景-一次性','once','','no','scene','1','','1','示例场景','示例产品','not_started','','','','',NULL,NULL,'admin','2023-12-13 07:18:56',NULL,NULL),(4,'示例任务-关联场景-每周六和每周日0点和20点执行','week','','no','scene','1','','1','示例场景','示例产品','not_started','0,20','','6,7','',NULL,NULL,'admin','2023-12-13 07:21:16',NULL,NULL),(3,'示例任务-关联场景-每天0点和12点执行','day','','no','scene','1','','1','示例场景','示例产品','not_started','','0,12','','',NULL,NULL,'admin','2023-12-13 07:20:23',NULL,NULL),(2,'示例任务-关联数据-自定义执行','cron',' */2 * * * *','no','data','','示例-用户管理-新建用户','1','','示例产品','not_started','','','','',NULL,NULL,'admin','2023-12-13 07:19:36',NULL,NULL);
...
-- Dump completed on 2026-09-16 13:55:02
-- ===== 内置数据：ai_template WHERE template_name IN ('接口定义生成测试用例','需求文档生成测试用例','接口定义生成测试数据','根据测试数据分析结果数据') =====
-- MySQL dump 10.13  Distrib 5.7.24, for osx10.9 (x86_64)
--
-- Host: 127.0.0.1    Database: data4test_1
-- ------------------------------------------------------
...
-- Dump completed on 2026-09-16 13:55:03
