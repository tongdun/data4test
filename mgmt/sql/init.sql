...
CREATE TABLE `api_definition` (
                                  ...
                                  `header` text COLLATE utf8_unicode_ci COMMENT 'Header参数',
                                  `path_variable` text COLLATE utf8_unicode_ci COMMENT 'PATH参数',
                                  `query_parameter` text COLLATE utf8_unicode_ci COMMENT 'Query参数',
                                  `body` text COLLATE utf8_unicode_ci COMMENT 'Body参数',
                                  `response` text COLLATE utf8_unicode_ci COMMENT 'Resp参数',
                                  ...
                                  `change_content` text COLLATE utf8_unicode_ci COMMENT '变更内容',
                                  `check` varchar(4) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '规范检查',
                                  `api_check_fail_reason` text COLLATE utf8_unicode_ci COMMENT '规范检查失败原因',
...
CREATE TABLE `api_fuzzing_data` (
                                    ...
                                    `api_module` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '所属模块',
                                    `header` text COLLATE utf8_unicode_ci COMMENT 'Header',
                                    `url_query` text COLLATE utf8_unicode_ci COMMENT 'UrlQuery',
                                    `body` text COLLATE utf8_unicode_ci COMMENT 'Body',
                                    ...
                                    `fail_reason` text COLLATE utf8_unicode_ci COMMENT '失败原因',
...
CREATE TABLE `api_test_result` (
                                   `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
                                   `api_id` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '接口ID',
                                   `out_vars` text COLLATE utf8_unicode_ci COMMENT '提供变量',
                                   `app` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '所属产品',
                                   `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                   `updated_at` timestamp NULL DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `app_api_changelog` (
                                     ...
                                     `newApiContent` text COMMENT '新增接口详情',
                                     `deletedApiContent` text COMMENT '删除接口详情',
                                     `changedApiContent` text COMMENT '变更接口详情',
                                     `apiCheckResult` varchar(255) DEFAULT NULL COMMENT '接口检查结果',
                                     `apiCheckFailContent` text COMMENT '规范检查失败接口详情',
...
CREATE TABLE `env_config` (
                              ...
                              `auth` text COLLATE utf8_unicode_ci COMMENT '鉴权信息',
...
CREATE TABLE `fuzzing_definition` (
                                      ...
                                      `value` text COLLATE utf8_unicode_ci NOT NULL COMMENT '值, e.g.: string, int, bool, list, dict',
...
CREATE TABLE `schedule` (
                            ...
                            `data_list` text COLLATE utf8mb4_unicode_ci COMMENT '关联数据',
                            `scene_number` text COLLATE utf8mb4_unicode_ci COMMENT '场景序号/标签',
                            `scene_list` text COLLATE utf8mb4_unicode_ci COMMENT '关联场景',
...
CREATE TABLE `sys_parameter` (
                                 ...
                                 `value_list` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '枚举列表',
                                 `remark` text COLLATE utf8mb4_unicode_ci COMMENT '备注',
                                 `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                 `updated_at` timestamp NULL DEFAULT NULL COMMENT '更新时间',
                                 `deleted_at` timestamp NULL DEFAULT NULL COMMENT '删除时间',
