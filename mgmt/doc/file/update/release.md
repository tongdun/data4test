#### 2026年9月17日
1、支持测试用例按指定模板导入，支持图片导入
2、支持测试用例按指定模板导出，支持图片嵌入和打包导出
3、支持测试用例进行测试过程记录、历史测试结果记录
4、支持根据测试用例统计定义出测试用例执行报告
5、支持测试用例、数据、场景、任务的数据国际化
6、单任务、多任务报告进行交互优化
7、子弹框确认后跳转异常问题全局修复

#### 2026年7月24日
1、系统支持国际化，支持中文和英文切换，控制台暂未国际化
2、任务支持查看报告，分单任务和多任务，多任务报告按需生成查看
3、应用、产品、全局的报告改成离线模式，可按需刷新查看，解决RT过高的问题
4、场景历史列表默认只展示前7列，按需选择其他列进行展示，支持缓存
