...
sudo rm -rf deploy/mgmt/download/*
sudo rm -rf deploy/mgmt/ai_data/*
sudo rm -rf deploy/mgmt/i18n/i18n_case/*
sudo rm -rf deploy/mgmt/i18n/i18n_caseCount/*
sudo rm -rf deploy/mgmt/i18n/i18n_data/*
sudo rm -rf deploy/mgmt/i18n/i18n_playbook/*
sudo rm -rf deploy/mgmt/i18n/i18n_task/*
sudo rm -rf deploy/mgmt/knowledge/*
sudo rm -rf deploy/mgmt/upload/*
sudo rm -rf deploy/mgmt/data/*
...
single:
  ...
  body:
    condition: "value":"{nameList}"  # {nameList} 代表字符串里有需替换的变更，nameList为 ouput 中输出的参数名字，在前置的用例中有定义同名变量，即会替换
...
response:
  - "response1"
  - "response2"
''' > deploy/mgmt/data/示例-用户管理-新建用户.yml